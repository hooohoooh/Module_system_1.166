...
# humanitarian
  ("loot_village", "attack the innocent"),
  ("steal_from_villagers", "steal from the poor"),
...
#npc22 = isosangemat
  ...
  ("npc17_backstory_response_1", "Why don't you join me?"),
...
("comment_intro_female_sadistic_admiring", "What have we here! A {pretty boy/woman}, caparisoned for war! Well, I dare say that one as fair as you could lend a touch of {delicacy/femininity} even to an O-Yoroi."),
...
#Combat-related events
  ...
  ("comment_you_captured_my_castle_enemy_spiteful",            "I hear that you have broken into my home at {s51}. I hope the servant's quarter is to your liking, as you will be spending much time there in the years to come."),
...
##diplomacy end+
  ("town", "town"),
  ("castle", "castle"),
  ("_but_he_is_holding_there_as_a_prisoner_at_dungeon_of_s13", " But {reg4?she:he} is being held there as a prisoner in the {s13}."),
...
##diplomacy end+
  ...
  ("bandit_hideout_success", "With their retreat cut off, the {s4} fall one by one to your determined attack. Their hideout, and their ill-gotten gains, are now yours."),
...
###################################################################################
 ...
 #--INTROS START--
 #intro format is "[intro1] [intro2] [intro3]" with "[accept]" and "[reject]" as options
 #single = 1, party = 2 to 30, army = 31+
 ("gekokujo_encounter_intro1_single_1", "You admire the scenery as you walk alone through the countryside."),
 ("gekokujo_encounter_intro1_single_2", "You maintain your pace as you trudge toward your destination."),
 ("gekokujo_encounter_intro1_single_3", "You begin to feel lonely at the thought of travelling the roads and trails by yourself."),
 ("gekokujo_encounter_intro1_single_4", "You begin to feel trepidation as you think about the chaos pervading the country."),
 ("gekokujo_encounter_intro1_party_1", "You are scouting ahead of the rest of your party."),
 ("gekokujo_encounter_intro1_party_2", "You have fallen behind the rest of your party."),
 ("gekokujo_encounter_intro1_party_3", "You let your party move ahead of you while you take care of personal 'business'."),
 ("gekokujo_encounter_intro1_party_4", "You take a side path away from the main body of your party in order to protect your flank."),
 ("gekokujo_encounter_intro1_army_1", "You run ahead of the main body of your troops, attempting to catch up to the the scouts."),
 ("gekokujo_encounter_intro1_army_2", "You fall back from the main body of your troops, in order to meet the baggage train."),
 ("gekokujo_encounter_intro1_army_3", "You had been travelling with the scouts when you decide to split away and return to the main body."),
 ("gekokujo_encounter_intro1_army_4", "You had been travelling with the baggage train when you decide to run ahead to the main body."),
 
 ("gekokujo_encounter_intro2_1", "All of a sudden,"),
 ("gekokujo_encounter_intro2_2", "Out of nowhere,"),
 ("gekokujo_encounter_intro2_3", "As if on cue,"),
 ("gekokujo_encounter_intro2_4", "Unexpectedly,"),
 
 ("gekokujo_encounter_intro3_1", "you hear a strange noise..."),
 ("gekokujo_encounter_intro3_2", "you hear eerie chanting..."),
 ("gekokujo_encounter_intro3_3", "you hear the rustling of foliage..."),
 ("gekokujo_encounter_intro3_4", "a voice seems to call out to you..."),
 ("gekokujo_encounter_intro3_5", "you notice movement in your periphery..."),
 ("gekokujo_encounter_intro3_6", "you see the silhouette of a person nearby..."),
 ("gekokujo_encounter_intro3_7", "you smell some unmistakeably human activity..."),
 ("gekokujo_encounter_intro3_8", "you hear something unambiguously metallic..."),
 ("gekokujo_encounter_intro3_9", "you hear a kind of sucking noise..."),
 ("gekokujo_encounter_intro3_10", "you hear a kind of slurping noise..."),
 ("gekokujo_encounter_intro3_11", "you hear what you think is an animal..."),
 ("gekokujo_encounter_intro3_12", "you hear the snapping of a twig..."),
 
 ("gekokujo_encounter_intro_accept_1", "I have to see."),
 ("gekokujo_encounter_intro_accept_2", "I have to know."),
 ("gekokujo_encounter_intro_accept_3", "I will investigate."),
 ("gekokujo_encounter_intro_accept_4", "I will check it out."),
 ("gekokujo_encounter_intro_accept_5", "Is anyone out there?"),
 ("gekokujo_encounter_intro_accept_6", "I wonder if that's a person..."),
 
 ("gekokujo_encounter_intro_reject_1", "No thanks."),
 ("gekokujo_encounter_intro_reject_2", "No. Just no."),
 ("gekokujo_encounter_intro_reject_3", "I shouldn't..."),
 ("gekokujo_encounter_intro_reject_4", "Not my problem."),
 ("gekokujo_encounter_intro_reject_5", "None of my business."),
 ("gekokujo_encounter_intro_reject_6", "I have to get out of here."),
 #--INTROS END--
 
 #--DESCRIPTIONS START--
 #description format is "[find] [a/an] [boss_count] [boss name] [circumstance] [mook_count] [mook]." 
 ("gekokujo_encounter_description_find_1", "You chance upon"),
 ("gekokujo_encounter_description_find_2", "It turns out to be"),
 ("gekokujo_encounter_description_find_3", "You find"),
 ("gekokujo_encounter_description_find_4", "You encounter"),
 
 #circumstances can be friendly or hostile
 ("gekokujo_encounter_description_circumstance_1", "and"),
 ("gekokujo_encounter_description_circumstance_2", "with"),
 ("gekokujo_encounter_description_circumstance_3", "together with"),
 ("gekokujo_encounter_description_circumstance_4", "travelling with"),
 ("gekokujo_encounter_description_circumstance_5", "leading around"),
 ("gekokujo_encounter_description_circumstance_6", "talking with"),
 ("gekokujo_encounter_description_circumstance_7", "having a chat with"),
 ("gekokujo_encounter_description_circumstance_8", "discussing something with"),
 ("gekokujo_encounter_description_circumstance_9", "in the middle of making a deal with"),
 ("gekokujo_encounter_description_circumstance_10", "eating a meal with"),
 ("gekokujo_encounter_description_circumstance_11", "waiting around with"),
 ("gekokujo_encounter_description_circumstance_12", "resting with"),
 ("gekokujo_encounter_description_circumstance_13", "yelling at"),
 ("gekokujo_encounter_description_circumstance_14", "arguing with"),
 ("gekokujo_encounter_description_circumstance_15", "laughing with"),
 ("gekokujo_encounter_description_circumstance_16", "hiding with"),
 ("gekokujo_encounter_description_circumstance_17", "lurking together with"),
 ("gekokujo_encounter_description_circumstance_18", "doing something obscene with"),
 ("gekokujo_encounter_description_circumstance_19", "in an intimate situation with"),
 ("gekokujo_encounter_description_circumstance_20", "taking care of 'business' some distance from"),
 #--DESCRIPTIONS END--
 
 #--HOSTILE ENCOUNTERS START--
 #this is what the boss says in a hostile encounter
 ("gekokujo_encounter_dialogue_1", "Banzai!"),
 ("gekokujo_encounter_dialogue_2", "You saw!"),
 ("gekokujo_encounter_dialogue_3", "A stalker!"),
 ("gekokujo_encounter_dialogue_4", "Don't look!"),
 ("gekokujo_encounter_dialogue_5", "How dare you!"),
 ("gekokujo_encounter_dialogue_6", "Oh no! An ambush!"),
 ("gekokujo_encounter_dialogue_7", "What are you doing?!"),
 ("gekokujo_encounter_dialogue_8", "You've seen too much."),
 ("gekokujo_encounter_dialogue_9", "Oh no! We've been found!"),
 ("gekokujo_encounter_dialogue_10", "You! We were looking for you!"),
 ("gekokujo_encounter_dialogue_11", "You were a fool to come here."),
 ("gekokujo_encounter_dialogue_12", "Did you follow us? Prepare to die!"),
 ("gekokujo_encounter_dialogue_13", "You made a huge mistake coming here."),
 ("gekokujo_encounter_dialogue_14", "I don't know who you are, get out of my way!"),
 ("gekokujo_encounter_dialogue_15", "How much did you hear?! Forget it, time to die!"),
 ("gekokujo_encounter_dialogue_16", "I can't believe you saw us! Time for you to die!"),
 ("gekokujo_encounter_dialogue_17", "Wh-what? Were you sent to kill me? Not if I kill you first!"),
 ("gekokujo_encounter_dialogue_18", "I cannot allow you to live after you found me. Please forgive me."),
 ("gekokujo_encounter_dialogue_19", "How did you know we were Christians? Forgive me, Lord, that I must kill to protect your flock."),
 ("gekokujo_encounter_dialogue_20", "I don't know who you are, but I cannot let you escape and reveal my presence to the world. I apologize."),
 
 #this is what the player chooses 2 options from 
 #roll 0-10, then 0-9, then offset the second number by 1 if >= first number
 ("gekokujo_encounter_choice_1", "So be it."),
 ("gekokujo_encounter_choice_2", "Very well."),
 ("gekokujo_encounter_choice_3", "No matter."),
 ("gekokujo_encounter_choice_4", "(Draw Weapon)"),
 ("gekokujo_encounter_choice_5", "Come and get me."),
 ("gekokujo_encounter_choice_6", "I am not scared."),
 ("gekokujo_encounter_choice_7", "I am not scared!"),
 ("gekokujo_encounter_choice_8", "You have got to be joking."),
 ("gekokujo_encounter_choice_9", "I am sorry to have to kill you."),
 ("gekokujo_encounter_choice_10", "I don't know what you are talking about."),
 
 #this is what the player then says after the choice
 ("gekokujo_encounter_reply_1", "Banzai!"),
 ("gekokujo_encounter_reply_2", "I am ready for you."),
 ("gekokujo_encounter_reply_3", "Time for YOU to die."),
 ("gekokujo_encounter_reply_4", "A fight it is, then!"),
 ("gekokujo_encounter_reply_5", "Were you there the whole time?"),
 ("gekokujo_encounter_reply_6", "To die is as light as a feather."),
 ("gekokujo_encounter_reply_7", "Please forgive me, I do not wish to kill you."),
 ("gekokujo_encounter_reply_8", "I guess there is no way to talk you out of this"),
 ("gekokujo_encounter_reply_9", "I suppose there is no way to talk myself out of this."),
 ("gekokujo_encounter_reply_10", "This is all a misunderstanding, but I can see that it is too late to explain."),
 
 #win screen format is "[win1]^^[win2]" with {s11} as the item reward's name and {reg12} as the money reward total
 ("gekokujo_encounter_win1_1", "This was pointless."),
 ("gekokujo_encounter_win1_2", "Better them than you."),
 ("gekokujo_encounter_win1_3", "You won and they lost."),
 ("gekokujo_encounter_win1_4", "Was this all necessary?"),
 ("gekokujo_encounter_win1_5", "They died and you lived."),
 ("gekokujo_encounter_win1_6", "That's that, you suppose."),
 ("gekokujo_encounter_win1_7", "You stay alive to fight another day."),
 ("gekokujo_encounter_win1_8", "You are still not quite sure what happened."),
 ("gekokujo_encounter_win1_9", "You rest for a few minutes to calm down from your adrenaline rush. It's over."),
 ("gekokujo_encounter_win1_10", "In a different world, they could have been your friends. Instead they are dead."),
 
 ("gekokujo_encounter_win2_1", "Oh well. But the {s11} and {reg32} mon? Great!"),
 ("gekokujo_encounter_win2_2", "You take the {s11} and {reg32} mon from their corpses."),
 ("gekokujo_encounter_win2_3", "You pick up their {s11} and {reg32} mon as your just due."),
 ("gekokujo_encounter_win2_4", "Someone's {s11} and {reg32} mon were salvageable from the mess."),
 ("gekokujo_encounter_win2_5", "They won't need their {s11} anymore, so you take it, along with {reg32} mon."),
 ("gekokujo_encounter_win2_6", "You ask yourself if the {s11} and {reg32} mon you picked up were worth the trouble."),
 
 #loss screen format is "[lose1]^^[lose2]" with {reg12} as the money taken away
 ("gekokujo_encounter_lose1_1", "Die? Today? So it goes."),
 ("gekokujo_encounter_lose1_2", "You could have done better."),
 ("gekokujo_encounter_lose1_3", "This was not your best showing."),
 ("gekokujo_encounter_lose1_4", "Argh. How did you let that happen?"),
 ("gekokujo_encounter_lose1_5", "There was no way you could have won."),
 ("gekokujo_encounter_lose1_6", "You probably couldn't have done better."),
 ("gekokujo_encounter_lose1_7", "Knocked down, your opponents begin to rob you."),
 ("gekokujo_encounter_lose1_8", "You feel that you deserve to die after what just happened."),
 ("gekokujo_encounter_lose1_9", "You hear calls to behead you, and you are only able to burble in protest."),
 ("gekokujo_encounter_lose1_10", "You hear your enemies arguing over what to do with you. Beheading seems to be the consensus."),
 
 ("gekokujo_encounter_lose2_1", "But something scares your assailants away and they leave you alone after swiftly taking {s11}."),
 ("gekokujo_encounter_lose2_2", "But they sound like they didn't even want to fight you. They pick up {s11} for their trouble and leave you be."),
 ("gekokujo_encounter_lose2_3", "But maybe the victors recognize you, because they do not kill you. They take {s11} from your body."),
 ("gekokujo_encounter_lose2_4", "Before the winners can behead you, a rustling in the bushes frightens them and they run off with {s11} taken from your body."),
 ("gekokujo_encounter_lose2_5", "Instead of killing you, however, they merely take {s11} from your limp body and walk away. You wonder what that was all about."),
 ("gekokujo_encounter_lose2_6", "However, they think you are already dead. They take {s11} that you dropped in the heat of battle and disappear into the countryside."),
 
 #s13 is the name of the boss, reg14 is the number of the mooks, s15 is the plural name of the mooks, s16 is the result
 ("gekokujo_encounter_log", "{playername} encountered a single {s13} and {reg14} {s15} and {s16}"),
 ("gekokujo_encounter_log_won", "subdued them"),
 ("gekokujo_encounter_log_lost", "was defeated"),
 #--HOSTILE ENCOUNTERS END--
 
 #--FRIENDLY ENCOUNTERS START--
 #this is what a boss opens with in a friendly encounter
 ("gekokujo_encounter_greeting1_1", "You!"),
 ("gekokujo_encounter_greeting1_2", "Oh!"),
 ("gekokujo_encounter_greeting1_3", "Oh dear."),
 ("gekokujo_encounter_greeting1_4", "Hello there!"),
 ("gekokujo_encounter_greeting1_5", "Hello there, stranger."),
 ("gekokujo_encounter_greeting1_6", "Stay your hand!"),
 ("gekokujo_encounter_greeting1_7", "Oh, nice to meet you."),
 ("gekokujo_encounter_greeting1_8", "How are you this day?"),
 
 ("gekokujo_encounter_greeting2_1", "Are you friendly?"),
 ("gekokujo_encounter_greeting2_2", "Don't worry about me, I'm friendly."),
 ("gekokujo_encounter_greeting2_3", "I believe you're the one I'm looking for."),
 ("gekokujo_encounter_greeting2_4", "Nevermind, you're not the one I'm looking for."),
 ("gekokujo_encounter_greeting2_5", "Don't worry, I'm not a bandit."),
 ("gekokujo_encounter_greeting2_6", "Haha, I hope you're not a bandit!"),
 ("gekokujo_encounter_greeting2_7", "I wonder if we have the same destination."),
 ("gekokujo_encounter_greeting2_8", "I think you look familiar."),
 
 ("gekokujo_encounter_greetback", "Hello. What's the news?"), #proceed to offer
 ("gekokujo_encounter_greetignore", "I'm sorry. I have to go."), #end encounter
 ("gekokujo_encounter_greetattack", "(Attack)"), #fight boss and mooks
 
 #s11 = what the boss offers, #s12 = what the boss wants
 ("gekokujo_encounter_offer_1", "In any case, I have {s11} for you if I can have {s12}."),
 ("gekokujo_encounter_offer_2", "Hmm. Would you like {s11}? I'm trying to get {s12} for it."),
 ("gekokujo_encounter_offer_3", "Since you're here, are you interested in {s11}? Just give me {s12}."),
 ("gekokujo_encounter_offer_4", "Well, I'm trying to get rid of {s11}. I'd like {s12} in exchange."),
 ("gekokujo_encounter_offer_5", "Are you interested in a trade? I want {s12} for {s11}."),
 ("gekokujo_encounter_offer_6", "Say, do you have {s12}? I can give you {s11} for it."),
 ("gekokujo_encounter_offer_7", "Wait, you have {s12}! Please let me have it for {s11}!"),
 ("gekokujo_encounter_offer_8", "Oh, you have {s12}? Would you like {s11} for it?"),
 #--FRIENDLY ENCOUNTERS END--
 ...
 #gekokujo 3.1 beg start
 ("gekokujo_beg_success", "You are given {reg10} mon in alms."),
 ("gekokujo_beg_fail", "You are driven away by irate locals."),
 
 ("gekokujo_beg_success_reply_1", "Oh my! Let me help!"),
 ("gekokujo_beg_success_reply_2", "Please let me help you."),
 ("gekokujo_beg_success_reply_3", "Damn beggars! Whatever, you can have this."),
 ("gekokujo_beg_success_reply_4", "This is everything I have with me right now, please take it."),
 ("gekokujo_beg_success_reply_5", "Here, please accept this token. It is the best that I can do."),
 
 ("gekokujo_beg_fail_reply_1", "Disgusting!"),
 ("gekokujo_beg_fail_reply_2", "Go away, idiot."),
 ("gekokujo_beg_fail_reply_3", "You can't be serious."),
 ("gekokujo_beg_fail_reply_4", "Are you drunk, {sir/madam}?"),
 ("gekokujo_beg_fail_reply_5", "What do you think you're doing?"),
 #gekokujo 3.1 beg end
 
 #gekokujo 3.1 crimes start
 ("gekokujo_crime_success", "You take {reg10} mon from your hapless mark."),
 ("gekokujo_crime_fail", "You were not able to take anything from your target."),
 ("gekokujo_getaway_success", "{s6} Somehow, you walk away without raising immediate alarm."),
 ("gekokujo_getaway_fail", "{s6} The alarm is raised, however, and you are eventually cornered by {s7}."),
 
 ("gekokujo_mug_success_reply_1", "Oh no!"),
 ("gekokujo_mug_success_reply_2", "Please don't kill me!"),
 ("gekokujo_mug_success_reply_3", "Here, take everything!"),
 ("gekokujo_mug_success_reply_4", "Damn you! Fine, take it all."),
 ("gekokujo_mug_success_reply_5", "This is everything I have, please spare my life!"),
 
 ("gekokujo_mug_fail_reply_1", "Help! Help!"),
 ("gekokujo_mug_fail_reply_2", "Go away, idiot."),
 ("gekokujo_mug_fail_reply_3", "You can't be serious."),
 ("gekokujo_mug_fail_reply_4", "Are you drunk, {sir/madam}?"),
 ("gekokujo_mug_fail_reply_5", "Do you think that's enough to scare me?"),
 
 ("gekokujo_pickpocket_success_reply_1", "Huh? What is it?"),
 ("gekokujo_pickpocket_success_reply_2", "Excuse me, please."),
 ("gekokujo_pickpocket_success_reply_3", "Ah, my apologies for running into you."),
 ("gekokujo_pickpocket_success_reply_4", "Weird. I thought I felt something brush past me."),
 ("gekokujo_pickpocket_success_reply_5", "Be careful out here. There are pickpockets about."),
 
 ("gekokujo_pickpocket_fail_reply_1", "Help! Help!"),
 ("gekokujo_pickpocket_fail_reply_2", "Stop! Thief!"),
 ("gekokujo_pickpocket_fail_reply_3", "I'm being robbed!"),
 ("gekokujo_pickpocket_fail_reply_4", "You idiot! What are you even trying to accomplish?"),
 ("gekokujo_pickpocket_fail_reply_5", "You have made quite a stupid mistake, little {man/lady}."),
 
 ("gekokujo_crime_fight_town_type", "the town guards"),
 ("gekokujo_crime_fight_town_success", "You fell the guards that were chasing after you. After finding their comrades, the rest of the town watch decides that going after you is probably not worth it. All you have to do now is wait for things to cool down and you can move onto new marks..."),
 ("gekokujo_crime_fight_town_fail", "You have fallen. Instead of beheading you, the guards laugh amongst themselves as they rough you up further and take what coin they can find from your body. They give you one final kick in the head before leaving. At least you are still alive, if barely."),
 
 ("gekokujo_crime_fight_village_type", "a mob of angry villagers"),
 ("gekokujo_crime_fight_village_success", "You are able to fight off the villagers. Their neighbors become hesitant to follow after you, despite their numbers. You have gotten away, though far from cleanly."),
 ("gekokujo_crime_fight_village_fail", "You have fallen. The villagers quickly search your body for every coin they can find, then leave your body to the elements. They probably expect you to die."),
 
 ("gekokujo_stalking_reply_1", "Huh? What is it?"),
 ("gekokujo_stalking_reply_2", "Excuse me, please."),
 ("gekokujo_stalking_reply_3", "Ah, my apologies for running into you."),
 ("gekokujo_stalking_reply_4", "Weird. I thought someone was following me."),
 ("gekokujo_stalking_reply_5", "Be careful out here. There are strange people about."),
 
 ("gekokujo_stalking_success", "You successfully follow your mark"),
 ("gekokujo_stalking_fail", "You were not able to keep up with your target. Oh well, as long as nobody raised the alarm..."),
 
 ("gekokujo_burglary_town_1", "{s6} to their pathetic 4.5-mat tenement.^^Shall you steal what little they have anyway?"),
 ("gekokujo_burglary_town_2", "{s6} to their house. After doing something inside, they quickly leave and walk back the way you both came from.^^Shall you break and enter?"),
 ("gekokujo_burglary_town_3", "{s6} to a merchant's mansion, where they work as a servant.^^It's a fairly large place -- you could probably steal from the other side and your mark would never notice."),
 ("gekokujo_burglary_town_4", "{s6} to a samurai's mansion, where they work as a servant.^^It's a fairly large place -- you could probably steal from the other side and your mark would never notice."),
 ("gekokujo_burglary_village_1", "{s6} to their farm at the the village outskirts.^^They are in and out of the farmhouse fairly quickly, walking back to the village the way you both came."),
 ("gekokujo_burglary_village_2", "{s6} down a deserted road. They stop to eat...^^They set down what they were carrying on the walk over. You could probably grab it without them noticing."),
 ("gekokujo_burglary_village_3", "{s6} as they wander into the woods. They start to gather firewood...^^They dropped a bag off to the side while working. You could probably grab it without them noticing."),
 ("gekokujo_burglary_village_4", "{s6} as they hike a riverbank away from the village. They begin fishing...^^They dropped a bag off to the side while working. You could probably grab it without them noticing. "),
 
 ("gekokujo_burglary_odds", "{s6}^^{reg12}% to steal, {reg13}% to avoid notice"),
 ("gekokujo_burglary_success", "You take items and coins worth {reg10} mon from your hapless mark."),
 ("gekokujo_burglary_fail", "You were not able to take anything from your target. Maybe you had to leave quickly. Maybe there was nothing you could carry around insconpiciously."),
 
 ("gekokujo_burglary_fight_town_1_easy", "family members that happened to arrive."),
 ("gekokujo_burglary_fight_town_2_easy", "family members that happened to arrive."),
 ("gekokujo_burglary_fight_town_3_easy", "family members and servants that you didn't notice."),
 ("gekokujo_burglary_fight_town_4_easy", "servants you didn't notice."),
 ("gekokujo_burglary_fight_town_1_hard", "family members and neighbors who showed up to help."),
 ("gekokujo_burglary_fight_town_2_hard", "family members and neighbors who showed up to help."),
 ("gekokujo_burglary_fight_town_3_hard", "the mansion's hired guards."),
 ("gekokujo_burglary_fight_town_4_hard", "the retainers guarding the mansion."),
 ("gekokujo_burglary_fight_village_1_easy", "somebody in the farm you did not notice."),
 ("gekokujo_burglary_fight_village_2_easy", "some do-gooder walking down the road."),
 ("gekokujo_burglary_fight_village_3_easy", "some do-gooder that was also in the woods."),
 ("gekokujo_burglary_fight_village_4_easy", "some do-gooder fishing by the riverbank."),
 ("gekokujo_burglary_fight_village_1_hard", "family members that happened to arrive."),
 ("gekokujo_burglary_fight_village_2_hard", "a mob of villagers who happened to be on the road."),
 ("gekokujo_burglary_fight_village_3_hard", "a mob of villagers who happened to be in the woods."),
 ("gekokujo_burglary_fight_village_4_hard", "a mob of villagers who happened to be sharing the river."),
 
 ("gekokujo_burglary_fight_town_success", "You are able to fight off the townspeople and escape without further confrontation. You have gotten away, though far from cleanly."),
 ("gekokujo_burglary_fight_town_fail", "You have fallen. The townspeople quickly search your body for every coin they can find and rough you up further. They give you one final kick in the head before dropping you into a dark storehouse. You are not completely out, however, and you crawl away before anyone can return."),
 ("gekokujo_burglary_fight_guards_success", "You fell the guards that confronted you, allowing you to escape the mansion. All you have to do now is wait for things to cool down and you can move onto new marks..."),
 ("gekokujo_burglary_fight_guards_fail", "You have fallen. Instead of beheading you, the guards laugh amongst themselves as they rough you up further and take what coin they can find from your body. They give you one final kick in the head before dropping you into a dark storehouse. You are not completely out, however, and you crawl away before anyone can return."),
 ("gekokujo_burglary_fight_village_success", "You are able to fight off the villagers. There is nobody else around to see what has happened or to report to to village. You have gotten away, though far from cleanly."),
 ("gekokujo_burglary_fight_village_fail", "You have fallen. The villagers quickly search your body for every coin they can find, then leave your body to the elements. They probably expect you to die."),
   ## CC
  ("battlefield_small", "小 战 场"),
  ("battlefield_normal", "中 战 场"),  
  ("battlefield_large", "大 战 场"),
  ("battlefield_extra_large", "超 大 战 场"),
  ## CC
 ...
 # LAV MODIFICATIONS START (COMPANIONS OVERSEER MOD)
  ...
  # Upgrade system strings
  ("upgrade_all",             "Upgrade All"),
  ("upgrade_cost",            "Upgrade Cost: {reg60} mon"),
  ("upgrade_template_btn",    "Upgrade Template"),
  ("upgrade_reset",           "Reset Default"),
  ("upgrade_save",            "Save"),
  ("upgrade_no_troops",       "No troops to upgrade."),
  ("upgrade_insufficient",    "Insufficient funds. Upgraded as many as possible."),
  ("upgrade_complete",        "All troops upgraded successfully."),
  ("upgrade_template_saved",  "Upgrade template saved."),
  ("upgrade_branch_label",    "Upgrade Preference"),
  ...
  ("lco_i_denars",           "{reg60} gold(s)"), # No longer used as of V1.20
