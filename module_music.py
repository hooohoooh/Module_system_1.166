...
tracks = [
  ...
  ("victorious_evil", "gekokujo_victorious_evil.ogg", 0, 0),
  ("victorious_neutral_1", "gekokujo_victorious_evil.ogg", mtf_sit_victorious, 0),
  ("victorious_neutral_2", "gekokujo_victorious_evil.ogg", mtf_sit_victorious, 0),
  ("victorious_neutral_3", "gekokujo_victorious_evil.ogg", mtf_sit_victorious, 0),
  ...
  #gekokujo ambushed
  ("gekokujo_ambushed_1", "korogi_ambushed_1.ogg", mtf_module_track|mtf_sit_ambushed|mtf_sit_siege, mtf_sit_fight|mtf_sit_multiplayer_fight),
  ...
  ("gekokujo_ambushed_3", "hmix_ambushed.ogg", mtf_module_track|mtf_sit_ambushed|mtf_sit_siege, mtf_sit_fight|mtf_sit_multiplayer_fight),
  ...
  #gekokujo bandits
  ("gekokujo_bandit_1", "khamukkamu_bandit_1.ogg", mtf_module_track|mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_sit_travel, 0),
  ("gekokujo_bandit_2", "khamukkamu_bandit_2.ogg", mtf_module_track|mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_sit_travel, 0),
  
  #gekokujo siege battle
  ("gekokujo_siege_1", "khamukkamu_siege_1.ogg", mtf_module_track|mtf_sit_siege, mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_sit_ambushed),
  ("gekokujo_siege_2", "khamukkamu_siege_2.ogg", mtf_module_track|mtf_sit_siege, mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_sit_ambushed),
  ("gekokujo_siege_3", "khamukkamu_siege_3.ogg", mtf_module_track|mtf_sit_siege, mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_sit_ambushed),
  ...
  ("gekokujo_fight_1", "rathmor_battle_2.mp3", mtf_module_track|mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_sit_ambushed, 0),
  ("gekokujo_fight_2", "rathmor_battle_3.mp3", mtf_module_track|mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_sit_ambushed, 0),
  ...
  ("gekokujo_fight_7", "hmix_battle.ogg", mtf_module_track|mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_sit_ambushed, 0),
  ...
  ("gekokujo_infiltration_2", "hmix_infiltration.ogg", mtf_module_track|mtf_sit_town_infiltrate, 0),
  ...
  #gekokujo day travel
  ("gekokujo_travel_1", "rathmor_travel_1.mp3", mtf_module_track|mtf_sit_travel, mtf_sit_town|mtf_sit_night|mtf_sit_tavern),
  ("gekokujo_travel_2", "rathmor_travel_2.mp3", mtf_module_track|mtf_sit_travel, mtf_sit_town|mtf_sit_night|mtf_sit_tavern),
  ("gekokujo_travel_3", "rathmor_travel_3.mp3", mtf_module_track|mtf_sit_travel, mtf_sit_town|mtf_sit_night|mtf_sit_tavern),
  ("gekokujo_travel_4", "ilodolly_travel.ogg", mtf_module_track|mtf_sit_travel, mtf_sit_town|mtf_sit_night|mtf_sit_tavern),
  ("gekokujo_travel_5", "hmix_travel.ogg", mtf_module_track|mtf_sit_travel, mtf_sit_town|mtf_sit_night|mtf_sit_tavern),
  
  #gekokujo towns
  ("gekokujo_town_1", "khamukkamu_town_1.ogg", mtf_module_track|mtf_sit_town|mtf_sit_travel, mtf_sit_tavern|mtf_sit_night),
  ...
  ("gekokujo_town_8", "hmix_town.ogg", mtf_module_track|mtf_sit_town|mtf_sit_travel, mtf_sit_tavern|mtf_sit_night),
