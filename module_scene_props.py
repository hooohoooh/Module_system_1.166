...
scene_props = [
  ...
  #gekokujo 3.1 disable certain chests start
  ...
  #gekokujo 3.1 disable certain chests end
...
("oil_press_interior",0,"oil_press_interior","bo_oil_press_interior", []),
 ...
 ("mine_a",0,"mine_a","bo_mine_a", []),
  ...
  ("gekokujo_c2_gate_large", sokf_moveable, "gekokujo_c2_gate_large", "bo_gekokujo_c2_gate_large", []),
  ("gekokujo_c2_gate_small", sokf_moveable, "gekokujo_c2_gate_small", "bo_gekokujo_c2_gate_small", []),
  ...
  #gekokujo 3.1 masonman props start
  ("mk_wallscroll_1",0,"mk_arena_wallscroll_1","bo_mk_arena_wallscroll_1", []),
  ("mk_shoecubbies",0,"mk_arena_shoecubbies","bo_mk_arena_shoecubbies", []),
  ("mk_entrygeta",0,"mk_arena_entrygeta","bo_mk_arena_entrygeta", []),
  ("mk_candleholder",0,"mk_arena_candleholder","bo_mk_arena_candleholder", []),
  ("mk_writingdesk",0,"mk_arena_writingdesk","bo_mk_arena_writingdesk", []),
  ("mk_saddlerack",0,"mk_arena_saddlerack","bo_mk_arena_saddlerack", []),
  ("mk_cabinets",0,"mk_arena_backroomcabinets","bo_mk_arena_backroomcabinets", []),
  ("mk_coins_three",0,"mk_arena_coins_three","bo_mk_arena_coins_three", []),
  ("mk_coins_baskets",0,"mk_arena_goldbaskets","bo_mk_arena_goldbaskets", []),
  ("mk_shrine",0,"mk_arena_shrine","bo_mk_arena_shrine", []),
  ("mk_taiko_drum",0,"mk_arena_taikodrum","bo_mk_arena_taikodrum", []),
  ("mk_cochin",0,"mk_arena_chochin","mk_arena_chochin", []),
  ("mk_tray",0,"mk_arena_trayarrangement","bo_mk_arena_trayarrangement", []),
  ("mk_towels",0,"mk_arena_towelsonstumps","bo_mk_arena_towelsonstumps", []),
  #gekokujo 3.1 masonman props end
