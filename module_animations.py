...
#   [3.0, "myanim", 0, 50, arf_cyclic|arf_loop_pos_0_25],
   [3.5, "idle_stand_standart_2", 0, 72, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [11.0, "stand_man_new2", 0, 334, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [7.0, "stand_man_new3", 0, 152, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [7.5, "idle_stand_break_new_2", 0, 106, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [7.5, "idle_stand_break_new", 0, 106, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
...
##   [0.8, "jump_end_hard", 29, 54, arf_blend_in_1],
 ...
 ["stand_single", 0, amf_client_prediction,
   ...
   [10.0, "new_stand_man_jh", 0, 314, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [9.0, "one_handed_bni", 0, 314, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [9.0, "idle_stand_guard_break", 0, 275, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [9.5, "idle_stand_offensive", 0, 254, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [10.0, "sword_loop03", 0, 100, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [10.0, "sword_loop04", 0, 100, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [10.0, "sword_loop04repeat", 0, 100, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [8.0, "stand_1hlooped", 0, 115, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [7.5, "idle_stand_break_new_2", 0, 106, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [7.5, "idle_stand_break_new", 0, 106, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ["stand_greatsword", 0, amf_client_prediction,
   #gekokujo 3.1 jacobhinds animations start
   ...
   #gekokujo 3.1 jacobhinds animations end
 ],
 ["stand_staff", 0, amf_client_prediction,
[3.000000, "pike_loop02", 0, 60, arf_cyclic|arf_use_stand_progress, 0, (0.000000, 0.000000, 0.000000), 0.000000],
[8, "pike_loop05", 0, 99, arf_cyclic|arf_use_stand_progress, 0, (0.000000, 0.000000, 0.000000), 0.000000],
 ],
...
#   [0.8, "run_normal", 0, 12, arf_use_walk_progress|arf_cyclic|blend_in_walk,pack2f(0.4,0.9)], 
   ...
   [0.8, "run_onehanded_doublesaber", 0, 22, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
...
##   [0.8, "run_greatsword", 0, 22, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0], 
 [0.800000, "run_forward_staff_new", 0, 24, arf_make_walk_sound|arf_cyclic|arf_use_walk_progress, 58726, (0.000000, 0.000000,0.000000),  0.400000],
 [0.800000, "run_pike_3", 0, 24, arf_make_walk_sound|arf_cyclic|arf_use_walk_progress, 58726, (0.000000, 0.000000, 0.000000), 0.400000],
 [0.800000, "run_pike_1", 0, 24, arf_make_walk_sound|arf_cyclic|arf_use_walk_progress, 58726, (0.000000, 0.000000, 0.000000), 0.400000],
 [0.800000, "run_pike_3a", 0, 24, arf_make_walk_sound|arf_cyclic|arf_use_walk_progress, 58726, (0.000000, 0.000000, 0.000000),0.400000],
 [0.800000, "run_man_polearms_bni1", 0, 24, arf_make_walk_sound|arf_cyclic|arf_use_walk_progress, 58726, (0.000000, 0.000000, 0.000000),  0.400000],
 [0.800000, "run_man_polearms_bni2", 0, 24, arf_make_walk_sound|arf_cyclic|arf_use_walk_progress, 58726, (0.000000, 0.000000, 0.000000),  0.400000],
 [0.800000, "run_man_polearms_bni3", 0, 24, arf_make_walk_sound|arf_cyclic|arf_use_walk_progress, 58726, (0.000000, 0.000000, 0.000000),  0.400000],
 [0.800000, "run_man_polearms_bni4", 0, 24, arf_make_walk_sound|arf_cyclic|arf_use_walk_progress, 58726, (0.000000, 0.000000, 0.000000),  0.400000],
 [0.800000, "run_man_polearms_bni5", 0, 24, arf_make_walk_sound|arf_cyclic|arf_use_walk_progress, 58726, (0.000000, 0.000000, 0.000000),  0.400000],
 [0.800000, "run_man_polearms_bni6", 0, 24, arf_make_walk_sound|arf_cyclic|arf_use_walk_progress, 58726, (0.000000, 0.000000, 0.000000),  0.400000],
...
[0.800000, "run_forward_right_staff_new", 0, 24, arf_blend_in_3|arf_make_walk_sound|arf_cyclic|arf_use_walk_progress, 58726, (0.000000, 0.000000, 0.000000), 0.400000],
],
...
[0.800000, "run_forward_left_staff_new", 0, 24, arf_blend_in_3|arf_make_walk_sound|arf_cyclic|arf_use_walk_progress, 58726, (0.000000, 0.000000, 0.000000), 0.400000],
],
...
# duration and controlled via weapon speed.
 ...
 ["ready_crossbow", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_crossbow,
   [0.5, "musket_anims_new", 1, 4, arf_blend_in_6],
 ],
 ["release_crossbow", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_crossbow,
    [0.2, "musket_fire_1", 0, 19, arf_blend_in_1],
    [0.2, "musket_fire_2", 0, 19, arf_blend_in_1],
    [0.2, "musket_fire_3", 0, 19, arf_blend_in_1],
 ],
 ["reload_crossbow", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
    [2, "reload_bolt_single2", 1, 13, arf_blend_in_8|arf_make_custom_sound|arf_stick_item_to_left_hand, pack2f(0.94, 0.4), (0, 0, 0), 0],
  ],
  ["reload_crossbow_horseback", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
    [1.5, "reload_bolt_single2", 1, 13, arf_blend_in_8|arf_make_custom_sound|arf_stick_item_to_left_hand, pack2f(0.94, 0.4), (0, 0, 0), 0],
  ],
...
##   [1.0, "throw_stone", 21, 54, arf_blend_in_0],
 ...
 ["reload_pistol", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
    [4.2, "reload_pistol_new", 0, 160, arf_blend_in_8],
 ],
 ...
 ["release_musket", acf_anim_length(100)|acf_rot_vertical_bow, amf_priority_attack|amf_rider_rot_crossbow|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
    [0.4, "musket_fire_1", 0, 19, arf_blend_in_1],
    [0.4, "musket_fire_2", 0, 19, arf_blend_in_1],
    [0.4, "musket_fire_3", 0, 19, arf_blend_in_1],
  ],
 ["reload_musket", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
    [6.5, "rifle_reload", 0, 450, arf_blend_in_6|arf_stick_item_to_left_hand],
    [6.5, "line_musket_reload_ani", 0, 635, arf_blend_in_8|arf_stick_item_to_left_hand],
  ],
...
##   [3.0, "anim_human", 70100, 70150, arf_blend_in_5],
 ...
 ["stand_lady", 0, 0,
   ...
   [29.0, "jacobhinds_stand_lady", 0, 863, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   #gekokujo 3.1 jacobhinds animations end
 ],
 ["stand_lord", 0, 0,
...
#   [10.0, "anim_human_temp", 0, 10, arf_blend_in_5], 
 ...
 #gekokujo 3.1 jacobhinds animations start
 #this is actually a default animation (i believe) i am just partly implenting the way jacobhinds did it, so he gets credit
 #instead of replacing general polearm animations though, spears get a specialized one instead (these)
 #these already existed in native, we just enabled them properly in header_items just for spears (not naginata or staves)
 #the following 3 animations get flagged acf_rot_vertical_bow so that overhead swing attacks match mouse movement
 ["ready_overswing_spear", acf_rot_vertical_bow|acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction,
	[ready_durn, "spear_thrust_overhead", 0, 20, blend_in_ready],
 ],
 ["release_overswing_spear", acf_rot_vertical_bow|acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_continue_to_next,
 	[0.6, "spear_thrust_overhead", 20, 41, blend_in_release],
 ],
 ["release_overswing_spear_continue", acf_rot_vertical_bow, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
 ...
 #llf
 ["aim_cannon", 0, amf_priority_striked|amf_play|amf_client_owner_prediction,#amf_priority_striked
   [1, "Yuri_CannonAiming", 0, 19, arf_blend_in_0],
 ],
 ["fire_cannon", acf_enforce_all, amf_priority_fall_from_horse|amf_play|amf_client_owner_prediction,
   [1, "Yuri_CannonAiming", 0, 19, arf_blend_in_0],
 ],
 ["move_cannon", 0, amf_priority_rear|amf_play|amf_client_owner_prediction,
   [1, "Yuri_CannonRopePulling_Right", 0, 32, arf_blend_in_0],
 ],
 ["reload_cannon", acf_enforce_all, amf_priority_striked|amf_play|amf_client_owner_prediction,
   [5, "Yuri_CannonBarrelCleaningRight", 0, 17, arf_blend_in_0],
 ],
 #llf end
...
##   [2.5, "anim_horse", 505, 580,  arf_blend_in_8],
 ...
 ["Yuri_CannonEarsPlugging_Right_fire", acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_play|amf_client_prediction,
   [1.5, "Yuri_CannonEarsPlugging_Right", 0, 6, arf_blend_in_5],
 ],
 ...
 ["Yuri_CannonLighting_fire", acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_play|amf_client_prediction,
   [1.5, "Yuri_CannonLighting", 0, 2, arf_blend_in_5],
 ],
 ["Yuri_CannonBarrelCleaningLeft", acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_play|amf_client_prediction,
   [4.0, "Yuri_CannonBarrelCleaningLeft", 1, 17, arf_blend_in_0],
 ],
 ...
 ["banner_staff", 0, amf_client_prediction, 
[3.000000, "pike_loop02", 0, 60, arf_cyclic|arf_use_stand_progress, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],
 ]
