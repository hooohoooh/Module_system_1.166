...
###############################################################  
  ...
  ("town_3","Choshi", icon_town|pf_town, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(169.0, 173.0),[],120),
  ...
  ("town_16","Yonezawa", icon_town|pf_town, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(112.5, -44.9),[],270),
  ("town_17","Kubota", icon_town|pf_town, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(133.2, 65.1),[],60),
  ("town_18","Hirosaki", icon_town|pf_town, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(182.7, 69.2),[],360),
  ...
  ("town_26","Imahama", icon_town|pf_town, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-58.0, -123.0),[],315),
  ("town_27","Yamaguchi", icon_town|pf_town, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-290.4, -212.8),[],225),
  ("town_28","Izumo", icon_town|pf_town, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-213.9, -139.1),[],30),
  ...
  ("town_33","Osumi", icon_town|pf_town, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-276.5, -290.5),[],255),
  ("town_34","Kakegawa", icon_town|pf_town, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(34.0, -174.0),[],255),
  ("town_35","Kano", icon_town|pf_town, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-26.5, -144.5),[],255),
  ("town_36","Tenjinyama", icon_town|pf_town, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-140.0, -219.0),[],255),
  ("town_37","newtown1", icon_town|pf_town, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-119.2, -215.2),[],255),
  ("town_38","newtown2", icon_town|pf_town, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-115.6, -186.1),[],255),
  ("town_39","newtown3", icon_town|pf_town, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(110.0, -149.2),[],255),
...
#  Malabadi_Castle
  ...
  ("castle_7","Obama Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-85.0, -137.6),[],345),
  ("castle_8","Kannonji Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-60.0, -184.1),[],0),
  ("castle_9","Tanabe Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(149.0, -32.6),[],300),
  ("castle_10","Ichijodani Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-66.0, -160.0),[],105),
  ("castle_11","Sasayama Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-109.4, -169.0),[],165),
  ("castle_12","Tamaru Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-32, -197),[],135),
  ("castle_13","Yoshida Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-2.0, -179.5),[],150),
  ...
  ("castle_17","Iida Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(33.0, -122.0),[],0),
  ("castle_18","Shibata Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(101.4, -8.9),[],120),
  ("castle_19","Kaizu Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(46.0, -92.8),[],300),
  ("castle_20","Takatenjin Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(32.0, -181.0),[],75),
  ("castle_21","Ueda Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(39, -114),[],30),
  ("castle_22","Gifu Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-47.0, -147.0),[],300),
  ("castle_23","Gassantoda Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(142.0, -98.0),[],120),
  ("castle_24","Yoshiwara Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(66.0, -166.0),[],255),
  ...
  ("castle_27","Mihara Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-199.7, -194.3),[],225),
  ("castle_28","Tsuyama Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-169.7, -159.4),[],135),
  ...
  ("castle_31","Morioka Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(154.5, 118.5),[],255),
  ("castle_32","Ichinoseki Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(179.5, 33.3),[],135),
  ("castle_33","Yamagata Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(142.1, -3.4),[],45),
  ...
  ("castle_40","Nobeoka Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-58.6, -111.1),[],180),
  ("castle_41","Miyazaki Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-296.9, -339.5),[],300),
  ("castle_42","Aso Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-344.9, -255.6),[],60),
  ("castle_43","Sashiki Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-350, -296),[],15),
  ("castle_44","Yanagawa Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-340.8, -248.9),[],330),
  ("castle_45","Uwajima Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-240, -265),[],120),
  ("castle_46","Nakamura Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-245.8, -245.6),[],60),
  ("castle_47","Tokushima Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-155.0, -173.5),[],180),
  ...
  ("castle_49","Kawagoe Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(94.3, -120),[],120),
  ...
  ("castle_53","Sunpu Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(44.0, -168.0),[],300),
  ("castle_54","Okazaki Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-15.0, -173.0),[],210),
  ("castle_55","Nagashino Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(100.2, -95.7),[],150),
  ("castle_56","Iwamura Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(10.0, -140.0),[],0),
  ("castle_57","Takane Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(27, -137),[],180),
  ("castle_58","Ashigara Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(76.9, -102.6),[],360),
  ("castle_59","Matsukura Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(76.4, -45.7),[],60),
  ("castle_60","Shobara Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-183.0, -170.9),[],180),
  ("castle_61","Takahashi Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-190, -190),[],120),
  ("castle_62","Kurokawa Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(137.1, -24.2),[],210),
  ("castle_63","Hitachi Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(150.0, -58.5),[],135),
  ("castle_64","Kashima Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-355.3 , -251.7),[],285),
  ("castle_65","Hitoyoshi Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-327, -312),[],30),
  ("castle_66","Nakatsu Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-295.8, -241.8),[],240),
  ("castle_67","Muroto Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-75.7, -180.4),[],60),
  ("castle_68","Kawanoe Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-176.3, -200.1),[],180),
  
  #gekokujo new castles, 2nd addition
  ("castle_69","Otari Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(30.5, -101.9),[],30),
  ("castle_70","Iiyama Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(46, -85),[],240),
  ("castle_71","Iwakura Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(134.0, -72.0),[],60),
  ("castle_72","Nagashima Fortress", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-39.0, -169.0),[],180),
  
  #gekokujo new castles, 3rd addition
  ("castle_73","Katsuyama Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(138.0, 159.0),[],180),
  ("castle_74","Ishiyama Fortress", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-98.5, -188),[],60),
  ("castle_75","Jogu-ji Fortress", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-19.0, -177.0),[],30),
  
  ("castle_76","Taka Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-355.5, -239.0),[],180),
  ("castle_77","Usuki Fortress", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-265.3, -262.2),[],60),
  ("castle_78","Oka Fortress", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-291.3, -275.2),[],30),
  ("castle_79","Tamba Castle", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-92.5, -170.5),[],180),
  ("castle_80","Kawachi Fortress", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-112.5, -203.9),[],60),
  ("castle_81","Noda Fortress", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(85.0, -25.0),[],30),
  ("castle_82","Koyama Fortress", icon_castle_a|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(41.0, -170.0),[],30),
#     Rinimad      
