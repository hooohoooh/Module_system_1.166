...
#      (play_sound,"snd_quest_cancelled"),
	 ...
	 (store_random_in_range,":rand",0,11),
	  ...
	  (troop_set_slot, "trp_dark_knight_lord", slot_troop_age, 48),	
...
## Tocan- ##
  ...
  # Auto merge factions after 3 days
  (24,
   [
     (try_begin),
       (eq, "$g_faction_merge_done", 0),
       (store_current_day, ":cur_day"),
       (ge, ":cur_day", 2),
       (faction_set_slot, "fac_kingdom_28", slot_faction_state, sfs_active),
       (call_script, "script_give_center_to_faction_aux", "p_town_4", "fac_kingdom_28"),
       (call_script, "script_give_center_to_lord", "p_town_4", "trp_kingdom_28_lord", 0),
       (call_script, "script_merge_factions", "fac_kingdom_28", "fac_kingdom_4", "fac_kingdom_12", "fac_kingdom_15", "trp_kingdom_28_lord"),
       (assign, "$g_faction_merge_done", 1),
       (jump_to_menu, "mnu_xinzhengfuchengli"),
