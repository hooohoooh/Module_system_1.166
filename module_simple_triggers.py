...
## Invasion check
  (1,
    [
      ...
      (assign,"$invaded",1),
#      (display_message,"@A mysterious foreign power has descended upon the land.",0xff4040),
#      (play_sound,"snd_quest_cancelled"),
      (assign, "$g_dplmc_terrain_advantage", DPLMC_TERRAIN_ADVANTAGE_DISABLE),
	  (faction_set_slot, "fac_dark_knights", slot_faction_state, sfs_active), ##Tocan Invasion
      (call_script, "script_change_troop_faction", "trp_dark_knight_lord", "fac_dark_knights"),
      (call_script, "script_change_troop_faction", "trp_dark_knight_lord1", "fac_dark_knights"),
      (call_script, "script_change_troop_faction", "trp_dark_knight_lord2", "fac_dark_knights"),
      (call_script, "script_change_troop_faction", "trp_dark_knight_lord3", "fac_dark_knights"),
      (call_script, "script_change_troop_faction", "trp_dark_knight_lord4", "fac_dark_knights"),
      (call_script, "script_change_troop_faction", "trp_dark_knight_lord5", "fac_dark_knights"),
      (call_script, "script_change_troop_faction", "trp_dark_knight_lord6", "fac_dark_knights"),
      (call_script, "script_change_troop_faction", "trp_dark_knight_lord7", "fac_dark_knights"),
      (call_script, "script_change_troop_faction", "trp_dark_knight_lord8", "fac_dark_knights"),
      (call_script, "script_change_troop_faction", "trp_dark_knight_lord9", "fac_dark_knights"),
      (call_script, "script_change_troop_faction", "trp_dark_knight_lord10", "fac_dark_knights"),
      (call_script, "script_change_troop_faction", "trp_dark_knight_lord11", "fac_dark_knights"),
      (call_script, "script_change_troop_faction", "trp_dark_knight_lord12", "fac_dark_knights"),
      (call_script, "script_change_troop_faction", "trp_dark_knight_lord13", "fac_dark_knights"),
      (call_script, "script_change_troop_faction", "trp_dark_knight_lord14", "fac_dark_knights"),
      (call_script, "script_change_troop_faction", "trp_dark_knight_lord15", "fac_dark_knights"),
      (call_script, "script_change_troop_faction", "trp_dark_knight_lord16", "fac_dark_knights"),
      (call_script, "script_change_troop_faction", "trp_dark_knight_lord17", "fac_dark_knights"),
      (call_script, "script_change_troop_faction", "trp_dark_knight_lord18", "fac_dark_knights"),
      (call_script, "script_change_troop_faction", "trp_dark_knight_lord19", "fac_dark_knights"),
      (call_script, "script_change_troop_faction", "trp_dark_knight_lord20", "fac_dark_knights"),
	  
	  
	  (try_begin),
	       # player is head of own faction
	       (eq, "$players_kingdom", "fac_player_supporters_faction"),
		   (set_relation, "fac_player_supporters_faction", "fac_dark_knights", -40),
		   # select random other faction
		   ...
		   # (store_random_in_range,":rand",0,1),
		   # (eq,":rand",0),
		    # (set_relation, ":faction_no", "fac_dark_knights", -40),
			# (assign, ":center_no", "p_town_5"),
			# (str_store_faction_name,s1,":faction_no"),
			# (str_store_faction_name,s3,"fac_player_supporters_faction"),
			# (assign, ":faction_found", 1), 
		   # (try_end), 
	 ...
	 (store_random_in_range,":rand",0,11),
      (try_begin),
        ...
        (set_relation, "fac_kingdom_1", "fac_dark_knights", -40),
        (str_store_faction_name,s1,"fac_kingdom_1"),
      (else_try),
        (eq,":rand",1),
        (assign, ":center_no", "p_town_10"),
        (set_relation, "fac_kingdom_3", "fac_dark_knights", -40),
        (str_store_faction_name,s1,"fac_kingdom_3"),
      (else_try),
        (eq,":rand",2),
        (assign, ":center_no", "p_town_22"),
        (set_relation, "fac_kingdom_5", "fac_dark_knights", -40),
        (str_store_faction_name,s1,"fac_kingdom_5"),
      (else_try),
	    (eq,":rand",3),
        (assign, ":center_no", "p_town_5"),
        (set_relation, "fac_kingdom_4", "fac_dark_knights", -40),
        (str_store_faction_name,s1,"fac_kingdom_4"),
      (else_try), # new for Sarranids
	    (eq,":rand",4),
        (assign, ":center_no", "p_town_19"),
        (set_relation, "fac_kingdom_6", "fac_dark_knights", -40),
        (str_store_faction_name,s1,"fac_kingdom_6"),
      (else_try), 
	    (eq,":rand",5),
        (assign, ":center_no", "p_town_15"),
        (set_relation, "fac_kingdom_7", "fac_dark_knights", -40),
        (str_store_faction_name,s1,"fac_kingdom_7"),
      (else_try), 
	    (eq,":rand",6),
        (assign, ":center_no", "p_town_16"),
        (set_relation, "fac_kingdom_8", "fac_dark_knights", -40),
        (str_store_faction_name,s1,"fac_kingdom_8"),
      (else_try), 
	    (eq,":rand",7),
        (assign, ":center_no", "p_town_18"),
        (set_relation, "fac_kingdom_9", "fac_dark_knights", -40),
        (str_store_faction_name,s1,"fac_kingdom_9"),
      (else_try), 
	    (eq,":rand",8),
        (assign, ":center_no", "p_town_23"),
        (set_relation, "fac_kingdom_10", "fac_dark_knights", -40),
        (str_store_faction_name,s1,"fac_kingdom_10"),
      (else_try), 
	    (eq,":rand",9),
        (assign, ":center_no", "p_town_24"),
        (set_relation, "fac_kingdom_11", "fac_dark_knights", -40),
        (str_store_faction_name,s1,"fac_kingdom_11"),
      (else_try), 
	    (eq,":rand",10),
        (assign, ":center_no", "p_town_25"),
        (set_relation, "fac_kingdom_12", "fac_dark_knights", -40),
        (str_store_faction_name,s1,"fac_kingdom_12"),
      (else_try), 
        (assign, ":center_no", "p_town_8"),
        (set_relation, "fac_kingdom_2", "fac_dark_knights", -40),
      ...
      (try_begin),
        (eq,":rand",0),
        (assign, ":center_no", "p_town_26"),
        (set_relation, "fac_kingdom_4", "fac_dark_knights", -40),
        (set_relation, "fac_kingdom_2", "fac_dark_knights", -40),
        (set_relation, "fac_kingdom_12", "fac_dark_knights", -40),
        (str_store_faction_name,s1,"fac_kingdom_4"),
        (str_store_faction_name,s3,"fac_kingdom_2"),
        (str_store_faction_name,s4,"fac_kingdom_12"),
      (else_try),
        (eq,":rand",1),
        (assign, ":center_no", "p_town_27"),
        (set_relation, "fac_kingdom_4", "fac_dark_knights", -40),
        (set_relation, "fac_kingdom_7", "fac_dark_knights", -40),
        (set_relation, "fac_kingdom_8", "fac_dark_knights", -40),
        (str_store_faction_name,s1,"fac_kingdom_4"),
        (str_store_faction_name,s3,"fac_kingdom_7"),
        (str_store_faction_name,s4,"fac_kingdom_8"),
      (else_try),
        (eq,":rand",2),
        (assign, ":center_no", "p_town_28"),
        (set_relation, "fac_kingdom_4", "fac_dark_knights", -40),
        (set_relation, "fac_kingdom_7", "fac_dark_knights", -40),
        (set_relation, "fac_kingdom_8", "fac_dark_knights", -40),
        (str_store_faction_name,s1,"fac_kingdom_4"),
      ...
      (else_try),
	    (eq,":rand",3),
        (assign, ":center_no", "p_town_14"),
        (set_relation, "fac_kingdom_9", "fac_dark_knights", -40),
        (set_relation, "fac_kingdom_3", "fac_dark_knights", -40),
        (str_store_faction_name,s1,"fac_kingdom_9"),
        (str_store_faction_name,s3,"fac_kingdom_3"),
      (else_try), 
	    (eq,":rand",4),
        (assign, ":center_no", "p_town_22"),
        (set_relation, "fac_kingdom_1", "fac_dark_knights", -40),
        ...
        (str_store_faction_name,s4,"fac_kingdom_1"),
      (else_try), 
	    (eq,":rand",5),
        (assign, ":center_no", "p_town_10"),
        (set_relation, "fac_kingdom_3", "fac_dark_knights", -40),
        ...
        (set_relation, "fac_kingdom_8", "fac_dark_knights", -40),
        (str_store_faction_name,s1,"fac_kingdom_3"),
        (str_store_faction_name,s3,"fac_kingdom_9"),
        (str_store_faction_name,s4,"fac_kingdom_8"),
      (else_try), 
	    (eq,":rand",6),
        (assign, ":center_no", "p_town_17"),
        (set_relation, "fac_kingdom_3", "fac_dark_knights", -40),
        (set_relation, "fac_kingdom_9", "fac_dark_knights", -40),
        (set_relation, "fac_kingdom_8", "fac_dark_knights", -40),
        (str_store_faction_name,s1,"fac_kingdom_3"),
	  ...
	  (else_try),   
	       # player is a vassal
	       (set_relation, "$players_kingdom", "fac_dark_knights", -40),
		   # want them also to attack nearby kingdom
		   (store_random_in_range,":rand",0,1),
		   (try_begin), 
			...
			(else_try), 
		    (eq, "$players_kingdom", "fac_kingdom_9"),
		     (try_begin), 
		     (eq,":rand",0),
			   (try_begin), 
		       (faction_slot_eq, "fac_kingdom_3",  slot_faction_state, sfs_active),
			...
			(else_try), 
		    (eq, "$players_kingdom", "fac_kingdom_12"),
		     (try_begin), 
		     (eq,":rand",0),
			   (try_begin), 
			...
			(else_try),
		    # player vassal of kingdoms 13-27 (gekokujo extended)
		    (is_between, "$players_kingdom", "fac_kingdom_13", "fac_kingdoms_end"),
		    (set_relation, "$players_kingdom", "fac_dark_knights", -40),
		    (call_script, "script_cf_select_random_walled_center_with_faction", "$players_kingdom", "trp_player"),
		    (assign, ":center_no", reg0),
		    (call_script, "script_cf_faction_get_random_enemy_faction", "$players_kingdom"),
		    (neq, reg0, "fac_dark_knights"),
		    (set_relation, reg0, "fac_dark_knights", -40),
      ...
      # (else_try),
        ...
        # (set_relation, "fac_kingdom_1", "fac_dark_knights", -40),
        # (str_store_faction_name,s1,"fac_kingdom_5"),
        # (str_store_faction_name,s3,"fac_kingdom_1"),
      # (else_try),
	    # (eq,":rand",3),
        ...
        # (str_store_faction_name,s3,"fac_kingdom_2"),
      # (else_try), # new for Sarranids
        # (assign, ":center_no", "p_town_21"),
        # (set_relation, "fac_kingdom_6", "fac_dark_knights", -40),
        # (set_relation, "fac_kingdom_3", "fac_dark_knights", -40),
        # (str_store_faction_name,s1,"fac_kingdom_6"),
        # (str_store_faction_name,s3,"fac_kingdom_3"),
      # (try_end),
      (str_store_faction_name,s2,"fac_dark_knights"),
      (display_log_message, "@{s2} has declared war against {s1}."),
      (display_log_message, "@{s2} has declared war against {s3}."),
      (display_log_message, "@{s2} has declared war against {s4}."),
	  
	  (troop_set_name, "trp_dark_knight_lord",  "@General Qi Jiguang"),
	  (troop_set_slot, "trp_dark_knight_lord", slot_troop_age, 33),	
	  (troop_set_slot, "trp_dark_knight_lord", slot_troop_wealth, 100000),		  
      (call_script, "script_create_kingdom_hero_party_dk", "trp_dark_knight_lord", ":center_no"),
	  
	  (troop_set_name, "trp_dark_knight_lord1",  "@Commander Yu Dayou"),
	  (troop_set_slot, "trp_dark_knight_lord1", slot_troop_age, 39),
	  (troop_set_slot, "trp_dark_knight_lord1", slot_troop_renown, 1000),
	  (troop_set_slot, "trp_dark_knight_lord1", slot_troop_wealth, 10000),		  	  
      (call_script, "script_create_kingdom_hero_party_dk", "trp_dark_knight_lord1", ":center_no"),
	  
	  (troop_set_name, "trp_dark_knight_lord2",  "@Commander Tan Lun"),
	  (troop_set_slot, "trp_dark_knight_lord2", slot_troop_age, 31),
	  (troop_set_slot, "trp_dark_knight_lord2", slot_troop_renown, 1000),
	  (troop_set_slot, "trp_dark_knight_lord2", slot_troop_wealth, 10000),		  	  
      (call_script, "script_create_kingdom_hero_party_dk", "trp_dark_knight_lord2", ":center_no"),
	  
	  (troop_set_name, "trp_dark_knight_lord3",  "@Commander Hung Xue"),
	  (troop_set_slot, "trp_dark_knight_lord3", slot_troop_age, 30),
	  (troop_set_slot, "trp_dark_knight_lord3", slot_troop_renown, 1000),
	  (troop_set_slot, "trp_dark_knight_lord3", slot_troop_wealth, 10000),		  	  
      (call_script, "script_create_kingdom_hero_party_dk", "trp_dark_knight_lord3", ":center_no"),
	  
	  (troop_set_name, "trp_dark_knight_lord4",  "@Commander You Dai"),
	  (troop_set_slot, "trp_dark_knight_lord4", slot_troop_age, 43),	
	  (troop_set_slot, "trp_dark_knight_lord4", slot_troop_renown, 1000),
	  (troop_set_slot, "trp_dark_knight_lord4", slot_troop_wealth, 10000),		  	  
      (call_script, "script_create_kingdom_hero_party_dk", "trp_dark_knight_lord4", ":center_no"),	  
	  
	  (troop_set_name, "trp_dark_knight_lord5",  "@Commander Shu Hai"),
	  (troop_set_slot, "trp_dark_knight_lord5", slot_troop_age, 45),	
	  (troop_set_slot, "trp_dark_knight_lord5", slot_troop_renown, 1000),
	  (troop_set_slot, "trp_dark_knight_lord5", slot_troop_wealth, 10000),		  	  
      (call_script, "script_create_kingdom_hero_party_dk", "trp_dark_knight_lord5", ":center_no"),	

	  (troop_set_name, "trp_dark_knight_lord6",  "@Commander Zhuang Fuhua"),
	  (troop_set_slot, "trp_dark_knight_lord6", slot_troop_age, 27),
	  (troop_set_slot, "trp_dark_knight_lord6", slot_troop_renown, 600),
	  (troop_set_slot, "trp_dark_knight_lord6", slot_troop_wealth, 10000),		  	  
      (call_script, "script_create_kingdom_hero_party_dk", "trp_dark_knight_lord6", ":center_no"),	

	  (troop_set_name, "trp_dark_knight_lord7",  "@Commander Chuang Tsun-chung"),
	  (troop_set_slot, "trp_dark_knight_lord7", slot_troop_age, 44),
	  (troop_set_slot, "trp_dark_knight_lord7", slot_troop_renown, 900),
	  (troop_set_slot, "trp_dark_knight_lord7", slot_troop_wealth, 10000),		  	  
      (call_script, "script_create_kingdom_hero_party_dk", "trp_dark_knight_lord7", ":center_no"),	

	  (troop_set_name, "trp_dark_knight_lord8",  "@Commander Xiao Zhihuan"),
	  (troop_set_slot, "trp_dark_knight_lord8", slot_troop_age, 40),
	  (troop_set_slot, "trp_dark_knight_lord8", slot_troop_renown, 800),
	  (troop_set_slot, "trp_dark_knight_lord8", slot_troop_wealth, 10000),		  	  
      (call_script, "script_create_kingdom_hero_party_dk", "trp_dark_knight_lord8", ":center_no"),	

	  (troop_set_name, "trp_dark_knight_lord9",  "@Commander Shaw Jin"),
	  (troop_set_slot, "trp_dark_knight_lord9", slot_troop_age, 31),
	  (troop_set_slot, "trp_dark_knight_lord9", slot_troop_renown, 600),
	  (troop_set_slot, "trp_dark_knight_lord9", slot_troop_wealth, 10000),		  
      (call_script, "script_create_kingdom_hero_party_dk", "trp_dark_knight_lord9", ":center_no"),	

	  (troop_set_name, "trp_dark_knight_lord10",  "@Commander Lan Bai"),
	  (troop_set_slot, "trp_dark_knight_lord10", slot_troop_age, 29),
	  (troop_set_slot, "trp_dark_knight_lord10", slot_troop_renown, 600),
	  (troop_set_slot, "trp_dark_knight_lord10", slot_troop_wealth, 10000),		  
      (call_script, "script_create_kingdom_hero_party_dk", "trp_dark_knight_lord10", ":center_no"),	

	  (troop_set_name, "trp_dark_knight_lord11",  "@Commander Chang Zhong"),
	  (troop_set_slot, "trp_dark_knight_lord11", slot_troop_age, 34),
	  (troop_set_slot, "trp_dark_knight_lord11", slot_troop_renown, 700),
	  (troop_set_slot, "trp_dark_knight_lord11", slot_troop_wealth, 10000),		  
      (call_script, "script_create_kingdom_hero_party_dk", "trp_dark_knight_lord11", ":center_no"),	

	  (troop_set_name, "trp_dark_knight_lord12",  "@Commander Lui Zenguang"),
	  (troop_set_slot, "trp_dark_knight_lord12", slot_troop_age, 24),
	  (troop_set_slot, "trp_dark_knight_lord12", slot_troop_renown, 500),
	  (troop_set_slot, "trp_dark_knight_lord12", slot_troop_wealth, 10000),		  
      (call_script, "script_create_kingdom_hero_party_dk", "trp_dark_knight_lord12", ":center_no"),	

	  (troop_set_name, "trp_dark_knight_lord13",  "@Commander Qu Jian"),
	  (troop_set_slot, "trp_dark_knight_lord13", slot_troop_age, 35),
	  (troop_set_slot, "trp_dark_knight_lord13", slot_troop_renown, 700),
	  (troop_set_slot, "trp_dark_knight_lord13", slot_troop_wealth, 10000),		  
      (call_script, "script_create_kingdom_hero_party_dk", "trp_dark_knight_lord13", ":center_no"),	

	  (troop_set_name, "trp_dark_knight_lord14",  "@Commander Chou Yang"),
	  (troop_set_slot, "trp_dark_knight_lord14", slot_troop_age, 25),
	  (troop_set_slot, "trp_dark_knight_lord14", slot_troop_renown, 500),
	  (troop_set_slot, "trp_dark_knight_lord14", slot_troop_wealth, 10000),		  
      (call_script, "script_create_kingdom_hero_party_dk", "trp_dark_knight_lord14", ":center_no"),		 

	  (troop_set_name, "trp_dark_knight_lord15",  "@Commander Xu Fa"),
	  (troop_set_slot, "trp_dark_knight_lord15", slot_troop_age, 26),
	  (troop_set_slot, "trp_dark_knight_lord15", slot_troop_renown, 500),
	  (troop_set_slot, "trp_dark_knight_lord15", slot_troop_wealth, 10000),		  
      (call_script, "script_create_kingdom_hero_party_dk", "trp_dark_knight_lord15", ":center_no"),		

	  (troop_set_name, "trp_dark_knight_lord16",  "@Commander Zhen Lei"),
	  (troop_set_slot, "trp_dark_knight_lord16", slot_troop_age, 23),	
	  (troop_set_slot, "trp_dark_knight_lord16", slot_troop_renown, 500),
	  (troop_set_slot, "trp_dark_knight_lord16", slot_troop_wealth, 10000),		  
      (call_script, "script_create_kingdom_hero_party_dk", "trp_dark_knight_lord16", ":center_no"),		

	  (troop_set_name, "trp_dark_knight_lord17",  "@Commander Tian Chen"),
	  (troop_set_slot, "trp_dark_knight_lord17", slot_troop_age, 22),
	  (troop_set_slot, "trp_dark_knight_lord17", slot_troop_renown, 500),
	  (troop_set_slot, "trp_dark_knight_lord17", slot_troop_wealth, 10000),		  
      (call_script, "script_create_kingdom_hero_party_dk", "trp_dark_knight_lord17", ":center_no"),		

	  (troop_set_name, "trp_dark_knight_lord18",  "@Commander Meng Qianfan"),
	  (troop_set_slot, "trp_dark_knight_lord18", slot_troop_age, 42),
	  (troop_set_slot, "trp_dark_knight_lord18", slot_troop_renown, 800),
	  (troop_set_slot, "trp_dark_knight_lord18", slot_troop_wealth, 10000),		  
      (call_script, "script_create_kingdom_hero_party_dk", "trp_dark_knight_lord18", ":center_no"),		

	  (troop_set_name, "trp_dark_knight_lord19",  "@Commander Yue Qingsheng"),
	  (troop_set_slot, "trp_dark_knight_lord19", slot_troop_age, 27),
	  (troop_set_slot, "trp_dark_knight_lord19", slot_troop_renown, 600),
	  (troop_set_slot, "trp_dark_knight_lord19", slot_troop_wealth, 10000),		  
      (call_script, "script_create_kingdom_hero_party_dk", "trp_dark_knight_lord19", ":center_no"),		

	  (troop_set_name, "trp_dark_knight_lord20",  "@Commander Bao Yanlin"),
	  (troop_set_slot, "trp_dark_knight_lord20", slot_troop_age, 44),	
	  (troop_set_slot, "trp_dark_knight_lord20", slot_troop_renown, 900),
	  (troop_set_slot, "trp_dark_knight_lord20", slot_troop_wealth, 10000),	  
      (call_script, "script_create_kingdom_hero_party_dk", "trp_dark_knight_lord20", ":center_no"),	
...
## relations with marshall	
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord1", "trp_dark_knight_lord", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord1", "trp_dark_knight_lord2", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord1", "trp_dark_knight_lord3", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord1", "trp_dark_knight_lord4", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord1", "trp_dark_knight_lord5", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord1", "trp_dark_knight_lord6", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord1", "trp_dark_knight_lord7", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord1", "trp_dark_knight_lord8", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord1", "trp_dark_knight_lord9", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord1", "trp_dark_knight_lord10", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord1", "trp_dark_knight_lord11", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord1", "trp_dark_knight_lord12", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord1", "trp_dark_knight_lord13", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord1", "trp_dark_knight_lord14", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord1", "trp_dark_knight_lord15", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord1", "trp_dark_knight_lord16", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord1", "trp_dark_knight_lord17", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord1", "trp_dark_knight_lord18", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord1", "trp_dark_knight_lord19", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord1", "trp_dark_knight_lord20", 100),	  
## relations with king	  
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord", "trp_dark_knight_lord1", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord", "trp_dark_knight_lord2", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord", "trp_dark_knight_lord3", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord", "trp_dark_knight_lord4", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord", "trp_dark_knight_lord5", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord", "trp_dark_knight_lord6", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord", "trp_dark_knight_lord7", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord", "trp_dark_knight_lord8", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord", "trp_dark_knight_lord9", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord", "trp_dark_knight_lord10", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord", "trp_dark_knight_lord11", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord", "trp_dark_knight_lord12", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord", "trp_dark_knight_lord13", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord", "trp_dark_knight_lord14", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord", "trp_dark_knight_lord15", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord", "trp_dark_knight_lord16", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord", "trp_dark_knight_lord17", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord", "trp_dark_knight_lord18", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord", "trp_dark_knight_lord19", 100),
	  (call_script, "script_troop_change_relation_with_troop", "trp_dark_knight_lord", "trp_dark_knight_lord20", 100),	  	  
	  
	  (troop_set_note_available, "trp_dark_knight_lord", 1),
	  (troop_set_note_available, "trp_dark_knight_lord1", 1),
	  (troop_set_note_available, "trp_dark_knight_lord2", 1),
	  (troop_set_note_available, "trp_dark_knight_lord3", 1),
	  (troop_set_note_available, "trp_dark_knight_lord4", 1),
	  (troop_set_note_available, "trp_dark_knight_lord5", 1),
	  (troop_set_note_available, "trp_dark_knight_lord6", 1),
	  (troop_set_note_available, "trp_dark_knight_lord7", 1),
	  (troop_set_note_available, "trp_dark_knight_lord8", 1),
	  (troop_set_note_available, "trp_dark_knight_lord9", 1),
	  (troop_set_note_available, "trp_dark_knight_lord10", 1),
	  (troop_set_note_available, "trp_dark_knight_lord11", 1),
	  (troop_set_note_available, "trp_dark_knight_lord12", 1),
	  (troop_set_note_available, "trp_dark_knight_lord13", 1),
	  (troop_set_note_available, "trp_dark_knight_lord14", 1),
	  (troop_set_note_available, "trp_dark_knight_lord15", 1),
	  (troop_set_note_available, "trp_dark_knight_lord16", 1),
	  (troop_set_note_available, "trp_dark_knight_lord17", 1),
	  (troop_set_note_available, "trp_dark_knight_lord18", 1),
	  (troop_set_note_available, "trp_dark_knight_lord19", 1),
	  (troop_set_note_available, "trp_dark_knight_lord20", 1),	  
	  
	  
	  (faction_set_note_available, "fac_dark_knights", 1), ## Tocan Invasion	
	  (call_script, "script_appoint_faction_marshall", "fac_dark_knights", "trp_dark_knight_lord1"), 	  
      (call_script, "script_update_all_notes"),	
	  
	  #right, no hanging around
	  # (call_script, "script_decide_faction_ai_dk2", "fac_dark_knights"),
	  	#xxxxxxxxxxxxxxxxxxxxxxxx
	    (faction_set_slot, "fac_dark_knights", slot_faction_ai_state, sfai_attacking_center),
        (faction_set_slot, "fac_dark_knights", slot_faction_ai_object, ":center_no"),
	
	######################### (call_script, "script_update_troop_notes", ":cur_troop"),
	
	  #(call_script, "script_find_center_to_attack_alt_dk", "trp_dark_knight_lord", 1, 0),
      # (assign, "$g_recalculate_ais", 1),
...
## Are the Dark Knights a threat yet?
   (24,
    [
      (eq,"$invaded",1),
      (assign,":centers",0),
      (try_for_range,":center_no",walled_centers_begin,walled_centers_end),
        (store_faction_of_party, ":faction", ":center_no"),
        (eq,":faction","fac_dark_knights"),
        (val_add,":centers",1),
      (try_end),
      (ge,":centers",8), #4 or more walled centers, start a war with everyone
      (assign,"$invaded",2),
#      (set_relation, "fac_player_faction", "fac_dark_knights", -40),
      (try_for_range, ":faction_no", "fac_kingdom_1", "fac_kingdoms_end"),
        (set_relation, ":faction_no", "fac_dark_knights", -40),
      (try_end),
      (str_store_faction_name,s1,"fac_dark_knights"),
      (display_message,"@The leaders of Japan have realized the threat the {s1} represent and have unanimously declared war on them."),
      (assign, "$g_recalculate_ais", 1),
   ]),
