...
#menu_world_map_soldier
    ...
    [
     ...
     (set_background_mesh, "mesh_gekokujo_pic_recruits"), #gekokujo 3.1 change freelancer ui
...
#menu_aud_with_commander 
  (
    ...
    [
        #(set_background_mesh, "mesh_pic_soldier_world_map"),
        (set_background_mesh, "mesh_gekokujo_pic_arms_other"), #gekokujo 3.1 change freelancer ui
    ...
    [
        ...
        (set_background_mesh, "mesh_gekokujo_pic_bandits_1"), #gekokujo 3.1 change freelancer ui
        (str_store_troop_name, s6, "$enlisted_lord")
    ],
    [
    ...
    [
        #(set_background_mesh, "mesh_pic_soldier_rebel"),
        (set_background_mesh, "mesh_gekokujo_pic_bandits_2"), #gekokujo 3.1 change freelancer ui
    ...
    [
        ...
        (set_background_mesh, "mesh_gekokujo_pic_escape"), #gekokujo 3.1 change freelancer ui
    ],
    [
