...
common_init_cannon=(
	...
	[
		(try_for_agents,":cannoneer"),
            ...
            #(agent_set_scripted_destination,":cannoneer",pos31),
    ...
    [
      (try_for_agents,":cannoneer"),
		...
		(try_begin),
			...
			#(agent_set_position,":cannoneer",pos35),
			(agent_set_animation,":cannoneer","anim_aim_cannon",1),
			(try_begin),
				(ge,":assistant",0),
				(agent_is_active,":assistant"),
				(agent_is_alive,":assistant"),
				(agent_set_animation,":assistant","anim_reload_cannon"),
				#(prop_instance_get_position,pos35,":cannon"),
				#(position_move_x,pos35,50),#
				#(agent_get_position,pos35,":assistant"),
				#(agent_set_scripted_destination,":assistant",pos35),
			(try_end),
		(else_try),
			(position_move_y, pos31,200),
			...
			(try_begin),
				...
				(agent_is_active,":assistant"),
				(agent_is_alive,":assistant"),
				(agent_set_animation,":assistant","anim_move_cannon"),#1
				#(agent_clear_scripted_mode,":assistant"),
			(try_end),
		(try_end),
	  (try_end),
    ])
		...
		(try_for_agents,":cannoneer"),
			...
			(try_begin),
				...
				(else_try),#
					...
					#llf
					(agent_set_animation,":cannoneer","anim_fire_cannon",1),
					(try_begin),
						(ge,":assistant",0),
						(agent_is_active,":assistant"),
						(agent_is_alive,":assistant"),
						(agent_set_animation,":assistant","anim_fire_cannon"),
					(try_end),
					#llf end
				(try_end),
			(else_try),
				(neg|agent_is_alive,":cannoneer"),
				(scene_prop_set_visibility,":cannon",0),
				(prop_instance_get_position,pos35,":cannon"),
				(position_move_z,pos35,-1000,1),
				(prop_instance_animate_to_position,":cannon",pos35,1),
			(try_end),
		(try_end),
	])
trigger_cannon=[
...
bodyguard_triggers = [
 ...
 (ti_on_agent_spawn, 0, 0, [], 
   [
	...
	(try_begin),
		(this_or_next|eq, ":troop", "trp_hired_agent"), 
		(eq, ":troop", "trp_female_agent"),
		
		(agent_unequip_item,":agent","itm_gekokujo_kimono_1_1"),
		(agent_unequip_item,":agent","itm_gekokujo_kimono_1_2"),
		(agent_unequip_item,":agent","itm_gekokujo_kimono_2_1"),
		(agent_unequip_item,":agent","itm_gekokujo_kimono_2_2"),
		
		(store_random_in_range, ":troop_seed", 1, 5), #roll the dice
		(store_random_in_range, ":clothes_seed", 1, 7), #roll the dice
		(try_begin), #check the results and assign the new equipment
			(eq, ":troop_seed", 1), #1/4 peasant
			(agent_equip_item,":agent","itm_gekokujo_sugegasa_1", 4),
			(try_begin),
				(eq, ":clothes_seed", 1), 
				(agent_equip_item,":agent","itm_gekokujo_kimono_1_1"),
			(else_try),
				(eq, ":clothes_seed", 2), 
				(agent_equip_item,":agent","itm_gekokujo_kimono_1_2"),
			(else_try),
				(eq, ":clothes_seed", 3), 
				(agent_equip_item,":agent","itm_gekokujo_kimono_1_3"),
			(else_try),
				(eq, ":clothes_seed", 4), 
				(agent_equip_item,":agent","itm_gekokujo_kimono_2_1"),
			(else_try),
				(eq, ":clothes_seed", 5), 
				(agent_equip_item,":agent","itm_gekokujo_kimono_2_2"),
			(else_try),
				#(eq, ":clothes_seed", 6), 
				(agent_equip_item,":agent","itm_gekokujo_kimono_2_3"),
			(try_end),
		(else_try),
			(eq, ":troop_seed", 2), #1/4 unarmored samurai
			(try_begin),
				(eq, ":clothes_seed", 1), 
				(agent_equip_item,":agent","itm_gekokujo_haori_1"),
			(else_try),
				(eq, ":clothes_seed", 2), 
				(agent_equip_item,":agent","itm_gekokujo_haori_2"),
			(else_try),
				(eq, ":clothes_seed", 3), 
				(agent_equip_item,":agent","itm_gekokujo_haori_3"),
			(else_try),
				(eq, ":clothes_seed", 4), 
				(agent_equip_item,":agent","itm_gekokujo_haori_4"),
			(else_try),
				(eq, ":clothes_seed", 5), 
				(agent_equip_item,":agent","itm_gekokujo_haori_5"),
			(else_try),
				#(eq, ":clothes_seed", 6), 
				(agent_equip_item,":agent","itm_gekokujo_haori_6"),
			(try_end),
		(else_try),
			(eq, ":troop_seed", 3), #1/4 monk
			(agent_equip_item,":agent","itm_gekokujo_kimono_2_monk"),
			(agent_equip_item,":agent","itm_gekokujo_monk_headwrap"),
		(else_try),
			#(eq, ":troop_seed", 4), #1/4 townswoman
			(try_begin),
				(eq, ":clothes_seed", 1), 
				(agent_equip_item,":agent","itm_gekokujo_kimono_3_1"),
			(else_try),
				(eq, ":clothes_seed", 2), 
				(agent_equip_item,":agent","itm_gekokujo_kimono_3_2"),
			(else_try),
				(eq, ":clothes_seed", 3), 
				(agent_equip_item,":agent","itm_gekokujo_kimono_3_3"),
			(else_try),
				(eq, ":clothes_seed", 4), 
				(agent_equip_item,":agent","itm_gekokujo_kimono_3_4"),
			(else_try),
				(eq, ":clothes_seed", 5), 
				(agent_equip_item,":agent","itm_gekokujo_kimono_3_5"),
			(else_try),
				#(eq, ":clothes_seed", 6), 
				(agent_equip_item,":agent","itm_gekokujo_kimono_3_6"),
			(try_end),
		(try_end),
	(try_end),
    
    #copy over hakama variations for yojimbos
	(try_begin),
		(eq, ":troop", "trp_yojimbo"),
		
		(agent_unequip_item,":agent","itm_gekokujo_hakama_1"),
		(agent_unequip_item,":agent","itm_gekokujo_hakama_2"),
		(agent_unequip_item,":agent","itm_gekokujo_hakama_3"),
		(agent_unequip_item,":agent","itm_gekokujo_hakama_4"),
		(agent_unequip_item,":agent","itm_gekokujo_hakama_5"),
		(agent_unequip_item,":agent","itm_gekokujo_hakama_6"),
		(agent_unequip_item,":agent","itm_gekokujo_haori_1"),
		(agent_unequip_item,":agent","itm_gekokujo_haori_2"),
		(agent_unequip_item,":agent","itm_gekokujo_haori_3"),
		(agent_unequip_item,":agent","itm_gekokujo_haori_4"),
		(agent_unequip_item,":agent","itm_gekokujo_haori_5"),
		(agent_unequip_item,":agent","itm_gekokujo_haori_6"),
		...
		(try_begin),
			(eq, ":clothes_seed", 1), 
			(agent_equip_item,":agent","itm_gekokujo_hakama_1"),
		(else_try),
			(eq, ":clothes_seed", 2), 
			(agent_equip_item,":agent","itm_gekokujo_hakama_2"),
		(else_try),
			(eq, ":clothes_seed", 3), 
			(agent_equip_item,":agent","itm_gekokujo_hakama_3"),
		(else_try),
			(eq, ":clothes_seed", 4), 
			(agent_equip_item,":agent","itm_gekokujo_hakama_4"),
		(else_try),
			(eq, ":clothes_seed", 5), 
			(agent_equip_item,":agent","itm_gekokujo_hakama_5"),
		(else_try),
			(eq, ":clothes_seed", 6), 
			(agent_equip_item,":agent","itm_gekokujo_hakama_6"),
		(else_try),
			(eq, ":clothes_seed", 7), 
			(agent_equip_item,":agent","itm_gekokujo_haori_1"),
		(else_try),
    ...
    [
      ...
      [
        (try_for_agents, ":agent"),
            ...
            (le, ":horse", 0), #ignore horsemen, they know what to use
            
            #ignore ashigaru troops, this is for bandits, ronin, onnabushi, mercs, companions, and lords
            (agent_get_troop_id, ":troop", ":agent"),
            (is_between, ":troop", "trp_gekokujo_uesugi_villager", "trp_gekokujo_uesugi_jizamurai"), 
            
            (agent_get_wielded_item, ":wielded", ":agent", 0),
            (try_begin),
                #if they're using a katana, tachi, wakizashi, or tanto
                (this_or_next|is_between, ":wielded", "itm_gekokujo_katana_1", "itm_gekokujo_nodachi_1"),
                (is_between, ":wielded", "itm_gekokujo_wakizashi_1", "itm_gekokujo_ninjato_1"),
                
                #and the enemy isn't swarming
                (agent_get_position, pos1, ":agent"),
                (agent_get_team, ":team_no", ":agent"),
                (call_script, "script_get_closest3_distance_of_enemies_at_pos1", ":team_no", pos1),
                (assign, ":avg_dist", reg0),
                (gt, ":avg_dist", 500), #are the enemies further than 5 meters?
            
                #find a longer weapon and switch
                (troop_get_inventory_capacity, ":inventory", ":troop"),
                (assign,":weapon_switch",0),
                (try_for_range, ":i", 0, ":inventory"),
                    (troop_get_inventory_slot,":item", ":troop", ":i"),
                    (this_or_next|is_between, ":item", "itm_gekokujo_nodachi_1", "itm_gekokujo_wakizashi_1"),
                    (this_or_next|is_between, ":item", "itm_gekokujo_ninjato_1", "itm_gekokujo_shuriken"),
                    (this_or_next|is_between, ":item", "itm_gekokujo_mongol_1", "itm_gekokujo_kama_1"),
                    (this_or_next|is_between, ":item", "itm_gekokujo_jo", "itm_gekokujo_yumi_1"),
                    (assign,":weapon_switch", 1),
                    (assign,":inventory", 0), #break loop
                (try_end),
                ...
                (try_end),
            (else_try),
                #if they're using a spear
                (is_between, ":wielded", "itm_gekokujo_yari_bamboo_1", "itm_gekokujo_kama_1"),
                
                #and the enemy is swarming
                (agent_get_position, pos1, ":agent"),
                (agent_get_team, ":team_no", ":agent"),
                (call_script, "script_get_closest3_distance_of_enemies_at_pos1", ":team_no", pos1),
                (assign, ":avg_dist", reg0),
                ...
                #find a shorter weapon and switch
                (troop_get_inventory_capacity, ":inventory", ":troop"),
                (assign,":weapon_switch",0),
                (try_for_range, ":i", 0, ":inventory"),
                    (troop_get_inventory_slot,":item", ":troop", ":i"),
                    (this_or_next|is_between, ":item", "itm_gekokujo_katana_1", "itm_gekokujo_nodachi_1"),
                    (this_or_next|is_between, ":item", "itm_gekokujo_wakizashi_1", "itm_gekokujo_ninjato_1"),
                    (assign,":weapon_switch", 1),
                    (assign,":inventory", 0), #break loop
                (try_end),
                
                (try_begin),
                    (eq, ":weapon_switch",1), #this is here twice because i assume its computationally cheaper this way
                    (agent_set_wielded_item, ":agent", ":item"),
                (try_end),
            (try_end),
...
##  ),
  ...
  (
    ...
    [
        ...
        (2,mtef_visitor_source,af_override_everything,0,1,[itm_gekokujo_kimono_2_2, itm_gekokujo_sandal_2]),
        (3,mtef_visitor_source,af_override_everything,0,1,[itm_gekokujo_kimono_2_1, itm_gekokujo_sandal_2]),
		#gekokujo 3.1 wedding end
    ...
    [
      ...
      (ti_on_agent_spawn, 0, 0, [],
       [
         ...
         (else_try),
           ...
           (position_rotate_z, pos1, 180),
           (agent_set_position, ":agent_no", pos1),
           (agent_set_animation, ":agent_no", "anim_stand_lord"),
		   #gekokujo 3.1 wedding end
         (else_try),
           (try_begin),
             (eq, ":gender", 0), #male
      ...
      (0, 0, 0,
       [
         ...
         (else_try),
           ...
           (try_for_agents, ":agent_no"),
             ...
             (try_begin),
               ...
               (agent_set_position, ":agent_no", pos1),
               (agent_set_animation, ":agent_no", "anim_stand_lady"),
             (else_try),
		 ...
		 #the following is the old wedding sequence:
         #(try_begin),
         #  (eq, "$g_wedding_state", 0),
         #  (mission_cam_set_mode, 1, 0, 0),
         #  (init_position, pos1),
    ...
    [
      ...
      (ti_on_agent_spawn, 0, 0, [],
       [
         ...
         (try_end),
         ###
         #gekokujo 3.1 integrating 1.166 change end
