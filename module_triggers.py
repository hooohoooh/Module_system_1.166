...
(try_for_agents, ":var_0"),
    ...
    (try_begin),
        ...
        (try_begin),
            ...
            (this_or_next|eq, ":var_8", 16),
            (this_or_next|eq, ":var_8", 17),
            (this_or_next|eq, ":var_8", 8),
            (this_or_next|eq, ":var_8", 9),
            (eq, ":var_8", 10),
            (assign, ":var_5", ":var_7"),
        (try_end),
        (neg|eq, ":var_9", 0),
        (agent_get_division, ":var_10", ":var_0"),
        (team_get_weapon_usage_order, ":var_11", ":var_4", ":var_10"),
        (team_get_movement_order, ":var_12", ":var_4", ":var_10"),
        (team_get_hold_fire_order, ":var_13", ":var_4", ":var_10"),
        (neg|eq, ":var_13", 1),
        (neg|eq, ":var_11", 2),
        (neg|eq, ":var_11", 1),
        (eq, ":var_12", 2),
        ...
        (assign, ":var_14", 15000),
        (assign, ":var_15", -1),
        (try_for_agents, ":var_16", 1, 150000),
            (agent_is_human, ":var_16"),
            (agent_is_alive, ":var_16"),
            (agent_get_position, pos2, ":var_16"),
            (agent_get_team, ":var_17", ":var_16"),
            (teams_are_enemies, ":var_4", ":var_17"),
            (get_distance_between_positions, ":var_18", pos1, pos2),
            (try_begin),
                (agent_slot_eq, ":var_16", slot_agent_is_running_away, 1),
                (val_add, ":var_18", 10000),
            (try_end),
            (agent_get_horse, ":var_19", ":var_16"),
            (try_begin),
                (neg|ge, ":var_19", 0),
                (val_sub, ":var_18", 3000),
            (try_end),
            (neg|ge, ":var_18", ":var_14"),
            (assign, ":var_14", ":var_18"),
            (assign, ":var_15", ":var_16"),
        (try_end),
        (gt, ":var_15", 0),
        (agent_get_position, pos3, ":var_15"),
        (get_distance_between_positions, ":var_20", pos1, pos3),
        (call_script, "script_team_get_average_position_of_enemies", ":var_4"),
        (assign, ":var_21", reg0),
        (try_begin),
            (gt, ":var_20", 100),
            (neg|ge, ":var_21", 20),
        ...
        (else_try),
            (gt, ":var_20", 100),
            (try_begin),
                (agent_get_wielded_item, ":var_22", ":var_0", 0),
                (gt, ":var_22", 0),
                (item_get_type, ":var_23", ":var_22"),
            (try_end),
            (try_begin),
                ...
                (try_begin),
                    ...
                    (position_get_x, ":var_24", pos0),
                    (position_get_y, ":var_25", pos0),
                    (position_transform_position_to_local, pos0, pos6, pos7),
                    (position_get_x, ":var_26", pos0),
                    (position_get_y, ":var_27", pos0),
                    (store_sub, ":var_28", ":var_26", ":var_24"),
                    (store_sub, ":var_29", ":var_27", ":var_25"),
                    (position_transform_position_to_local, pos0, pos1, pos3),
                    (position_get_x, ":var_30", pos0),
                    (position_get_y, ":var_31", pos0),
                    (assign, ":var_32", 0),
                    (assign, ":var_33", 1500),
                    (try_begin),
                        (neg|gt, ":var_14", ":var_9"),
                    ...
                    (else_try),
                        ...
                        (position_get_x, ":var_34", pos0),
                        (position_get_y, ":var_35", pos0),
                        (store_sub, ":var_36", ":var_26", ":var_34"),
                        (store_sub, ":var_37", ":var_27", ":var_35"),
                        (assign, ":var_38", ":var_33"),
                        (val_min, ":var_38", ":var_34"),
                        (val_min, ":var_38", ":var_37"),
                        (val_min, ":var_38", ":var_36"),
                        (val_min, ":var_38", ":var_35"),
                        (try_begin),
                            (neg|ge, ":var_38", ":var_33"),
                            (assign, ":var_32", 90),
                        (else_try),
                            (assign, ":var_32", 45),
                        (try_end),
                    (try_end),
                    (convert_to_fixed_point, ":var_32"),
                    (assign, ":var_38", ":var_33"),
                    (val_min, ":var_38", ":var_24"),
                    (val_min, ":var_38", ":var_29"),
                    (val_min, ":var_38", ":var_28"),
                    (val_min, ":var_38", ":var_25"),
                    (try_begin),
                        (neg|ge, ":var_14", 1000),
                        (neg|ge, ":var_38", ":var_33"),
                        (agent_slot_eq, ":var_15", slot_agent_is_running_away, 0),
                        (store_div, ":var_39", ":var_26", 20),
                        (store_div, ":var_40", ":var_27", 20),
                        (position_copy_origin, pos10, pos6),
                        (position_move_x, pos10, ":var_39", 1),
                        (position_move_y, pos10, ":var_40", 1),
                        (get_distance_between_positions, ":var_41", pos10, pos1),
                        (position_transform_position_to_local, pos0, pos1, pos10),
                        (position_get_x, ":var_39", pos0),
                        (position_get_y, ":var_40", pos0),
                        (val_mul, ":var_39", 100),
                        (val_mul, ":var_40", 100),
                        (val_mul, ":var_30", 100),
                        (val_mul, ":var_31", 100),
                        (store_div, ":var_42", ":var_39", ":var_41"),
                        (store_div, ":var_43", ":var_40", ":var_41"),
                        (store_div, ":var_44", ":var_30", ":var_20"),
                        (store_div, ":var_45", ":var_31", ":var_20"),
                        (store_acos, ":var_46", ":var_42"),
                        (store_asin, ":var_47", ":var_43"),
                        (store_acos, ":var_48", ":var_44"),
                        (store_asin, ":var_49", ":var_45"),
                        (try_begin),
                            (neg|ge, ":var_47", 0),
                            (val_mul, ":var_46", -1),
                            (val_add, ":var_46", 360000),
                        (try_end),
                        (try_begin),
                            (neg|ge, ":var_49", 0),
                            (val_mul, ":var_48", -1),
                            (val_add, ":var_48", 360000),
                        (try_end),
                        (store_sub, ":var_50", ":var_46", ":var_48"),
                        (val_sub, ":var_50", 270000),
                        (val_sub, ":var_50", ":var_32"),
                        (store_add, ":var_32", ":var_50", ":var_32"),
                        (try_begin),
                            (neg|ge, ":var_46", ":var_48"),
                            (val_add, ":var_32", 360000),
                        (try_end),
                        (val_clamp, ":var_32", -210000, 15000),
                    (try_end),
                    (try_begin),
                        (eq, ":var_23", 16),
                        (val_mul, ":var_32", -1),
                        (val_add, ":var_32", 180000),
                    (try_end),
                    (store_random_in_range, ":var_51", -350, 351),
                    (val_add, ":var_31", ":var_51"),
                    (store_cos, ":var_52", ":var_32"),
                    (store_sin, ":var_53", ":var_32"),
                    (store_mul, ":var_54", ":var_53", ":var_31"),
                    (store_mul, ":var_55", ":var_52", ":var_30"),
                    (store_sub, ":var_56", ":var_54", ":var_55"),
                    (store_random_in_range, ":var_57", -200, 200),
                    (val_max, ":var_56", 200),
                    (val_min, ":var_56", -200),
                    (position_move_x, pos1, ":var_57", 0),
                    (position_move_y, pos1, ":var_56", 0),
                (try_end),
        ...
        (try_begin),
            ...
            (gt, ":var_5", -1),
            (neg|ge, ":var_5", 1055),
            (agent_set_wielded_item, ":var_0", ":var_5"),
        (else_try),
            (neg|gt, ":var_20", ":var_58"),
            (agent_clear_scripted_mode, ":var_0"),
        (try_end),
    (else_try),
        (agent_clear_scripted_mode, ":var_0"),
...
##diplomacy begin
  ...
  [
    (try_begin),
      (eq, "$4_1", 1),
      (call_script, "script_diplomacy_start_war_between_kingdoms", "fac_kingdom_6", "fac_kingdom_28", 0),
      (call_script, "script_diplomacy_start_war_between_kingdoms", "fac_kingdom_1", "fac_kingdom_28", 0),
      (call_script, "script_diplomacy_start_war_between_kingdoms", "fac_kingdom_11", "fac_kingdom_28", 0),
      (dialog_box,"str_tutorial_map1"),
      (val_add, "$4_1", 1),
      (jump_to_menu, "mnu_niaoyufujianzhizhan"),
      (play_cue_track, "track_miyasansong"),
    (else_try),
  ]),
